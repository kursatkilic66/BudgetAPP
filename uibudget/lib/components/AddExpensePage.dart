...
//         "station": _gasStations.indexOf(_selectedStation),
//       };
...
//       };
//     } else if (_selectedCategory == "Araç Bakım" ||
...
//         "price": double.tryParse(_priceController.text) ?? 0.0,
//       };
//     } else if (_selectedCategory == "Ulaşım") {
//       apiUrl = "/api/TransportationOrders";
//       payload = {
//         "user_id": 1,
//         "name": _nameController.text,
...
//             if (_selectedCategory == "Ulaşım") ...[
//               _buildTextField(
//                 "Ulaşım Aracı (Örn: Otobüs, Taksi)",
...
//             if (_selectedCategory == "Araç Bakım" ||
//                 _selectedCategory == "Diğer") ...[
//               _buildTextField(
//                 "Harcama Adı",
...
class _AddExpensePageState extends State<AddExpensePage> {
  ...
  Future<void> _submitDataToApi() async {
    ...
    // --- YERELDEKİ DİNAMİK USER ID'Yİ ÇEK ---
    ...
    if (_selectedCategory == "Yakıt") {
      ...
      payload = {
        ...
        "car_id": 1, // Araç id'si de ileride benzer şekilde dinamik çekilebilir
        "unit_price": double.tryParse(_fuelUnitPriceCtrl.text) ?? 0.0,
        "total_price": double.tryParse(_fuelTotalPriceCtrl.text) ?? 0.0,
        "fuel_liter": double.tryParse(_fuelLiterCtrl.text) ?? 0.0,
        "station": _gasStations.indexOf(_selectedStation),
